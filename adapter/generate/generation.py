...
test_questions = "data/LaMP-42/{}/42_train.jsonl".format(args.task)
test_ids = []
data_list = []
...
ranking_path = "data/LaMP/{}/{}/{}_rankings_extended.json".format(args.task, args.mode, args.mode)
ranking_dict = {}
...
file_path = "data/LaMP/{}/{}/{}_questions_extended.json".format(args.task, args.mode, args.mode)
question_dict = {}
answer_dict = {}
with open(file_path, 'r') as f:
    ...
    for data in data_list:
        question_dict[data['id']] = data['input']

file_path = "data/LaMP/{}/{}/{}_outputs_extended.json".format(args.task, args.mode, args.mode)
# answer_dict = {}
with open(file_path, 'r') as f:
    for line in f:
        data = json.loads(line)
...
file_name = "{}.json".format(args.mode)
